                ...
                <div class="col-sm-12 owl-slider-1">
                    <div class="owl-carousel" data-margin="0" data-loop="yes" data-nav="yes" data-dots="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
                        ...
                        <div class="img-slider-1">
                                <a href="category.php?category_id=<?=$slider['category']?>"><img src="admin/uploads/mainslider/<?php echo $slider['logo']; ?>" alt=""></a>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="col-sm-12 banners">
            <?php foreach($getBanner as $key=>$banner): ?>
                ...
                <?php if($key == 0){?>
                    <a href="category.php?category_id=<?=$banner['category']?>"><img src="admin/uploads/banner/<?php echo $banner['logo']; ?>" alt=""></a>
                <?php } ?>
                </div>
            ...
            <div class="banner-right" style="margin-top: -5px; margin-left: 1px; width: 49%;">
                ...
                <div class="banner-right-bottom">
                    ...
                    <div class="banner-right-bottom-2" style="margin-top: -351px;">
                        <?php if($key == 3){?>
                            <a href="category.php?category_id=<?=$banner['category']?>"><img src="admin/uploads/banner/<?php echo $banner['logo']; ?>" alt=""></a>
                        <?php } ?>
                    </div>
