											...
											<div class="tabsslider  col-xs-12">
												...
												<div class="tab-content col-xs-12">
													...
													<div id="tab-review" class="tab-pane fade  in">
														<form action="admin/controller/ReviweController.php" method="post">
															<div id="review">
															...
															<div class="contacts-form">
																...
																<div class="form-group"> <span class="icon icon-bubbles-2"></span>
																	<textarea class="form-control" name="review" onblur="if (this.value == '') {this.value = 'Your Review';}" onfocus="if(this.value == 'Your Review') {this.value = '';}">Your Review</textarea>
																</div> 
                                                                ...
                                                                <div class="buttons clearfix"><button id="button-review" type="submit" class="btn buttonGray">Continue</button></div>
															</div>
														</form>
													</div>
